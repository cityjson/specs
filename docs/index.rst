...
It was also designed to be compact (it compresses with a factor of around 7X the CityGML files publicly available, `see here <https://github.com/tudelft3d/cityjson/wiki/Compression-factor-for-a-few-open-CityGML-datasets>`_), and to be friendly for web and mobile development.
